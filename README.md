...
## optim_coefm.R 
This code uses parameter flags within parameter files of the Agro-IBIS model and user defined observations to optimize parameter values fitting simulated outputs to observations. This code uses the function optim to solve the optimization problem. Code can be updated by user to optimize multiple parameters at one time using functionality in the optim function. 
